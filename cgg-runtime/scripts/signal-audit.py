...
Usage:
    python signal-audit.py metrics [--project-dir PATH]
    python signal-audit.py view [--project-dir PATH]
    python signal-audit.py compact [--project-dir PATH] [--dry-run]
    python signal-audit.py audit [--project-dir PATH]
"""
...
def cmd_audit(entries, tz_config):
