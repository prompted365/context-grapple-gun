...
# same typed failure details, same stderr wording, same counters, same call site
# and the same "only after a successful append" gate. Only the OWNER of the body
# moved: what lived here as a faithful copy of queue-lifecycle-writeback.
# recompile_effective_state now lives ONCE in lib/effective_state_recompile.py,
# and five writers call it. That closes F-802-B4 — "the recompile helper now
# exists in THREE copies held together by diligence" — handed up by this
# script's own tic-802 build seat.
#
