...
<!-- ledger-tags: authority_class=verification_and_proof_discipline | rung=domain | domain=context-grapple-gun | born_tic=637 | promoted_tic=640 | relations=refinement-ray:conductor-score-runtime-parity(federation),sibling:gate-example-template-must-teach-complete-pass-state,sibling:close-consistency-receipt-only-as-strong-as-artifact-verification,composes:inscribe-before-the-queue-write-that-cites-its-anchor | confidence_tier=tentative -->
